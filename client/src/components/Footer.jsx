      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1 space-y-4">
            <Link to="/" className="inline-block">
              <span className="text-2xl font-bold text-slate-900">
                Smart<span className="text-blue-600">EAI</span>
              </span>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link to="/home" className="hover:text-blue-600 transition">Resume Builder</Link></li>
              <li><Link to="/match" className="hover:text-blue-600 transition">Job Matcher</Link></li>
              <li><Link to="/features" className="hover:text-blue-600 transition">Cover Letters</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              ...
              <li><Link to="/cookie" className="hover:text-blue-600 transition">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="text-slate-400 hover:text-blue-800 transition">
              <span className="sr-only">LinkedIn</span>
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" /></svg>
            </a>
